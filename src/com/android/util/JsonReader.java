...
public final class JsonReader implements Closeable {
            ...
            while (pos < limit) {
                ...
                if (c == quote) {
                    if (skipping) {
                        ...
                        return stringPool.get(buffer, start, pos - start - 1, 0);
                    } else {
    ...
    private String nextLiteral(boolean assignOffsetsOnly) throws IOException {
        ...
        if (assignOffsetsOnly && builder == null) {
            ...
            result = stringPool.get(buffer, pos, i, 0);
        } else {
            builder.append(buffer, pos, i);
    ...
    private char readEscapeCharacter() throws IOException {
        ...
        switch (escaped) {
            case 'u':
                ...
                String hex = stringPool.get(buffer, pos, 4, 0);
                pos += 4;
    ...
    private JsonToken decodeLiteral() throws IOException {
        if (valuePos == -1) {
            ...
            value = stringPool.get(buffer, valuePos, valueLength, 0);

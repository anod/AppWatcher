...
sealed interface SectionHeader {
    data object New : SectionHeader
    data object RecentlyDiscovered : SectionHeader
    data object Watching : SectionHeader
    data object RecentlyInstalled : SectionHeader
    data object OnDevice : SectionHeader
}

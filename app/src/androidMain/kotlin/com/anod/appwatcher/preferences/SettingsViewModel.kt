...
sealed interface SettingsViewEvent {
    ...
    data object GDriveSyncNow : SettingsViewEvent
    ...
    data object OnBackNav : SettingsViewEvent
    data object TestNotification : SettingsViewEvent
    data object OssLicenses : SettingsViewEvent
    data object OpenUserLog : SettingsViewEvent
    data object OpenRefreshHistory : SettingsViewEvent
    class GDriveLoginResult(val isSuccess: Boolean, val errorCode: Int) : SettingsViewEvent
    data object NotificationPermissionRequest : SettingsViewEvent
    ...
    data object ShowAppSettings : SettingsViewEvent
    data object CheckNotificationPermission : SettingsViewEvent
    data object DbCleanup : SettingsViewEvent
}

sealed interface SettingsViewAction {
    class ActivityAction(val action: CommonActivityAction) : SettingsViewAction
    data object GDriveSignIn : SettingsViewAction
    data object GDriveSignOut : SettingsViewAction
    class GDriveErrorIntent(val intent: Intent) : SettingsViewAction
    data object Recreate : SettingsViewAction
    data object Rebirth : SettingsViewAction
    data object RequestNotificationPermission : SettingsViewAction

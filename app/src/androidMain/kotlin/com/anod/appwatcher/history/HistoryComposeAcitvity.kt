...
class HistoryListActivity : BaseComposeActivity(), KoinComponent {
    ...
    companion object {
        ...
        fun intent(context: Context, account: PersistedAccount?, authToken: String?): Intent = Intent(context, HistoryListActivity::class.java).apply {
            putExtra(EXTRA_ACCOUNT, account?.toAndroidAccount())

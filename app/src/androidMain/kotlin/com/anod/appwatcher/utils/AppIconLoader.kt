...
fun ComponentName.toIconUrl() =  Uri.fromParts(RealAppIconLoader.SCHEME, this.flattenToShortString(), null).toString()

fun String.packageNameToIconUrl() =  Uri.fromParts(RealAppIconLoader.SCHEME, ComponentName(this, this).flattenToShortString(), null).toString()

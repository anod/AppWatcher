...
data class PlainShowSnackbarData(val message: String, val duration: SnackbarDuration = SnackbarDuration.Short, val exitScreen: Boolean = false) : ShowSnackbarData

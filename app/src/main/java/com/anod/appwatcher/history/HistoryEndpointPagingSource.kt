...
class HistoryEndpointPagingSource(private val dfeApi: DfeApi, private val dateFormat: DateFormat = DateFormat.getDateInstance(DateFormat.MEDIUM), installedApps: InstalledApps,) :
    ...
    override suspend fun execute(nextPageUrl: String): ResponseWrapper = dfeApi.purchaseHistory(nextPageUrl)
}